...
<head>
    ...
    <title>تم التسجيل بنجاح - Jarak</title>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-lg">
            <div class="bg-white py-8 px-6 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600 mb-4">مرحباً بك في منصة Jarak</p>
                    <div class="rounded-lg p-4 text-right" style="background: var(--mint-green-light); border: 1px solid var(--navy-blue-light);">
                        ...
                        <p class="text-xs mt-2" style="color: var(--navy-blue);">سيتم إشعارك عبر البريد الإلكتروني عند تفعيل الحساب</p>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <ul class="text-sm text-gray-600 space-y-2">
                        <li class="flex items-start">
                            <span class="w-2 h-2 rounded-full mt-2 ml-2 flex-shrink-0" style="background: var(--navy-blue);"></span>
                ...
                <!-- Action Buttons -->
                <div class="space-y-3">
                    <a href="{{ route('lender.login') }}" class="btn-hover w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white" style="background: linear-gradient(135deg, var(--navy-blue) 0%, var(--mint-green) 100%);">
                    ...
                    <a href="{{ route('welcome') }}" class="btn-hover w-full flex justify-center py-3 px-4 border rounded-lg shadow-sm text-sm font-medium text-white" style="background: var(--mint-green-light); border-color: var(--navy-blue); color: var(--navy-blue);">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 text-center">
                    ...
                    <p class="text-sm font-medium" style="color: var(--navy-blue);">support@jarak.com</p>
                </div>
            </div>
        </div>
    </div>
