...
<head>
    ...
    <body class="bg-gradient-to-br from-green-50 via-blue-50 to-green-100 min-h-screen font-cairo" style="background: linear-gradient(135deg, var(--mint-green-light) 0%, rgba(0, 0, 128, 0.05) 50%, var(--mint-green-light) 100%);">
    <!-- Background Pattern -->
    ...
    <div class="relative min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <div class="flex justify-center">
                <div class="text-center">
                    <h1 class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-green-500">Jarak</h1>
                    <p class="text-sm text-gray-500 mt-1">منصة الإيجار الرائدة</p>
                </div>
            </div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                أو
                <a href="{{ route('lender.login') }}" class="font-medium text-blue-600 hover:text-blue-500 transition-colors">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-lg">
            <div class="form-card py-8 px-6 rounded-2xl">
                ...
                <form class="space-y-6" action="{{ route('lender.register') }}" method="POST" id="registrationForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="type-card selected border-2 border-gray-200 rounded-xl p-4 text-center" onclick="selectType('individual')">
                                <input id="individual" name="type" type="radio" value="individual" class="hidden" {{ old('type') == 'individual' ? 'checked' : 'checked' }}>
                            ...
                            <div class="type-card border-2 border-gray-200 rounded-xl p-4 text-center" onclick="selectType('company')">
                                <input id="company" name="type" type="radio" value="company" class="hidden" {{ old('type') == 'company' ? 'checked' : '' }}>
                    ...
                    <div class="space-y-4">
                        <h3 class="section-title text-lg font-bold border-b border-gray-200 pb-2">المعلومات الشخصية</h3>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none input-icon">
                                ...
                                <input id="name" name="name" type="text" required value="{{ old('name') }}" 
                                       ...
                                       onblur="validateField('name')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="email" name="email" type="email" autocomplete="email" required value="{{ old('email') }}" 
                                       class="input-focus block w-full pr-10 pl-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right"
                                       onblur="validateField('email')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="phone" name="phone" type="tel" required value="{{ old('phone') }}" 
                                       class="input-focus block w-full pr-10 pl-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right"
                                       onblur="validateField('phone')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="city" name="city" required 
                                        ...
                                        onblur="validateField('city')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 right-0 pr-3 pt-3 flex items-start pointer-events-none input-icon">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    </svg>
                    ...
                    <div id="company-fields" class="hidden space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="business_name" name="business_name" type="text" value="{{ old('business_name') }}" 
                                       class="input-focus block w-full pr-10 pl-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right"
                                       onblur="validateField('business_name')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select id="business_category" name="business_category" required 
                                        class="input-focus block w-full pr-10 pl-3 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right appearance-none bg-white"
                                        onblur="validateField('business_category')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)" onchange="handleCategoryChange()">
                                    <option value="">اختر النشاط التجاري</option>
                                    @foreach(\App\Models\Category::all() as $category)
                                        <option value="{{ $category->id }}" {{ old('business_category') == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                                    @endforeach
                                    <option value="other" {{ old('business_category') == 'other' ? 'selected' : '' }}>أخرى</option>
                                </select>
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                ...
                                <div class="error-message" id="business_category-error">يرجى اختيار النشاط التجاري</div>
                            </div>
                        </div>
                        ...
                        <div id="custom-activity-field" class="hidden">
                            ...
                            <div class="relative">
                                ...
                                <input id="custom_activity" name="custom_activity" type="text" value="{{ old('custom_activity') }}" 
                                       class="input-focus block w-full pr-10 pl-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right"
                                       onblur="validateField('custom_activity')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)"
                                       placeholder="أدخل النشاط التجاري المخصص">
                                <div class="error-message" id="custom_activity-error">يرجى إدخال النشاط التجاري المخصص</div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="file-input-wrapper">
                                ...
                                <input id="commercial_record" name="commercial_record" type="file" accept=".pdf" required 
                                       onblur="validateField('commercial_record')" onchange="updateFileLabel(this, 'commercial_record')">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="password" name="password" type="password" autocomplete="new-password" required 
                                       class="input-focus block w-full pr-10 pl-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right"
                                       onblur="validateField('password')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)">
                                <div class="error-message" id="password-error">كلمة المرور يجب أن تكون 8 أحرف على الأقل</div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" required 
                                       class="input-focus block w-full pr-10 pl-3 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-right"
                                       onblur="validateField('password_confirmation')" onfocus="handleInputFocus(this)" onblur="handleInputBlur(this)">
                                <div class="error-message" id="password_confirmation-error">كلمة المرور غير متطابقة</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('lender.login') }}" class="w-full flex justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
                            <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        ...
        function validateField(fieldName) {
            ...
            switch(fieldName) {
                ...
                case 'custom_activity':
                    if (document.getElementById('company').checked && document.getElementById('business_category').value === 'other') {
                        isValid = field.value.trim().length >= 2;
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            const requiredFields = ['name', 'email', 'phone', 'city', 'address', 'password', 'password_confirmation'];
            ...
            if (document.getElementById('company').checked) {
                ...
                if (document.getElementById('business_category').value === 'other') {
                    ...
                    if (customActivityElement.classList.contains('input-error') || customActivityElement.value.trim() === '') {
                        isValid = false;
                    }
                }
            }
