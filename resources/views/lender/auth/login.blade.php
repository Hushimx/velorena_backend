...
<head>
    ...
    <title>تسجيل دخول المقرض - Jarak</title>
...
<body class="bg-gradient-to-br from-green-50 via-blue-50 to-green-100 min-h-screen" style="background: linear-gradient(135deg, var(--mint-green-light) 0%, rgba(0, 0, 128, 0.05) 50%, var(--mint-green-light) 100%);">
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="max-w-md w-full space-y-8 p-10 form-card rounded-2xl card-shadow animate-fade-in">
            <div>
                <div class="flex justify-center">
                    <div class="text-center">
                        <h1 class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-800 to-green-500 mb-2">Jarak</h1>
            ...
            <div class="text-center mt-6">
                <p class="text-sm text-gray-600">
                    ليس لديك حساب؟
                    <a href="{{ route('lender.register') }}" class="font-medium text-blue-800 hover:text-blue-600 transition-colors">
                        إنشاء حساب جديد
                    </a>
                </p>
            </div>
