<div class="max-w-4xl mx-auto p-8 bg-white rounded-xl shadow-sm border border-gray-100">
    <h2 class="text-2xl font-semibold text-gray-900 mb-8">{{ trans('users.create_user') }}</h2>
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="flex space-x-6">
                <label class="inline-flex items-center space-x-2 cursor-pointer">
                    <input type="radio" x-model="clientType" value="individual"
                        @click="$wire.set('client_type', 'individual')"
                ...
                <label class="inline-flex items-center space-x-2 cursor-pointer">
                    <input type="radio" x-model="clientType" value="company"
                        @click="$wire.set('client_type', 'company')"
                        class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 ml-2">
        ...
        <script>
            document.addEventListener('alpine:init', () => {
                Alpine.data('clientType', () => ({
                    clientType: @entangle('client_type')
                }))
            })
        </script>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="password"
                        class="block text-sm font-medium text-gray-700 mb-1">{{ trans('users.password') }}*</label>
        ...
        <div class="pt-2">
            <button type="submit" wire:loading.attr="disabled"
                ...
                <span wire:loading.remove wire:target="save">
                    {{ trans('users.create_user_button') }}
                </span>
