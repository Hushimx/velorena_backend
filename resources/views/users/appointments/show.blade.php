...
@section('content')
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <h1 class="appointment-show-title">{{ trans('dashboard.appointment_details') }}</h1>
                        <p class="appointment-show-subtitle">{{ trans('dashboard.view_consultation_details') }}</p>
                    </div>
                            ...
                            <div class="info-card appointment-details-card">
                                ...
                                <div class="appointment-details-grid">
                                    <div class="detail-item">
                                        ...
                                        <span
                                            class="detail-value">{{ $appointment->formatted_date ?? trans('dashboard.not_set') }}</span>
                                    </div>
                                    <div class="detail-item">
                                        <span class="detail-label">{{ trans('dashboard.time') }}</span>
                                        <span
                                            class="detail-value">{{ $appointment->formatted_time ?? trans('dashboard.not_set') }}</span>
                                    </div>
                                    <div class="detail-item">
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <span
                                            class="detail-value">{{ $appointment->formatted_end_time ?? trans('dashboard.not_set') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <style>
        ...
        .appointment-show-header::before {
            content: '';
            position: absolute;
            top: -50%;
            left: -50%;
