...
<body>
    ...
    <!-- Sidebar -->
        @include('designer.layouts.includes.sidebar')
        <!-- Main Content -->
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="shadow-lg">
                <div class="px-4 lg:px-8 py-4 flex justify-between items-center">
                    ...
                    <h1 class="text-xl font-bold text-white">@yield('title', __('dashboard.designer_dashboard'))</h1>
                    <div class="flex items-center relative gap-4">
                        ...
                        <div class="relative ml-3">
                            <button id="profileDropdown" class="flex items-center focus:outline-none" onclick="toggleProfileDropdown()">
                                ...
                                <img class="profile-img" src="https://ui-avatars.com/api/?name={{ urlencode(Auth::guard('designer')->user()->name) }}&background=2a1e1e&color=ffde9f&rounded=true&size=64" alt="الصورة الشخصية">
                                <span class="hidden sm:block profile-name mr-2">{{ Auth::guard('designer')->user()->name }}</span>
                            </button>
                            ...
                            <div id="profileDropdownMenu" class="absolute left-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-lg border border-gray-600 py-2 z-50 hidden">
                                <a href="{{ route('designer.profile.edit') }}" class="flex items-center px-4 py-2 text-sm text-gray-200 hover:bg-gray-700 transition-colors">
                                    <i class="fas fa-user mr-3 text-gray-400"></i>
                                    <span>الملف الشخصي</span>
                                </a>
                                <div class="border-t border-gray-600 my-1"></div>
                                <form action="{{ route('designer.logout') }}" method="POST">
                @csrf
