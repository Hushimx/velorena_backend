            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold">
                        <i class="fas fa-hand-paper me-2" style="color: #ffde9f;"></i>
                        {{ __('dashboard.new_appointments') }}
                    </h1>
                    <p class="mt-1" style="color: #ffde9f;">{{ __('dashboard.claim_new_appointments') }}</p>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('designer.appointments.upcoming') }}"
                        ...
                        <span class="hidden sm:block">{{ __('dashboard.upcoming_appointments') }}</span>
                    </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <div class="w-12 h-12 rounded-lg flex items-center justify-center"
                        style="background-color: #f5d182; color: #2a1e1e;">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <div class="w-12 h-12 rounded-lg flex items-center justify-center"
                        style="background-color: #3a2e2e; color: #ffde9f;">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <div class="w-12 h-12 rounded-lg flex items-center justify-center"
                        style="background-color: #2a1e1e; color: #ffde9f;">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-gray-900">
                                        {{ $appointment->user->full_name ?? $appointment->user->email }}</p>
        ...
        @if ($upcomingAppointments->count() > 0)
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="{{ route('designer.appointments.upcoming') }}"
                        class="text-sm font-medium hover:underline flex items-center gap-2" style="color: #2a1e1e;">
