                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        @if ($item->designs && $item->designs->count() > 0)
                                                            <div class="mt-3">
                                                                <div
                                                                    class="text-xs font-medium text-gray-700 mb-2 flex items-center">
                                                                    <i class="fas fa-palette mr-1"></i>
                                                                    {{ trans('dashboard.attached_designs') }}:
                                                                </div>
                                                                <div class="space-y-2">
                                                                    @foreach ($item->designs as $orderItemDesign)
                                                                        @if ($orderItemDesign->design)
                                                                            <div
                                                                                class="flex items-center gap-2 bg-purple-50 px-2 py-1 rounded border-l-2 border-purple-300">
                                                                                <div class="flex-shrink-0">
                                                                                    ...
                                                                                    @else
                                                                                        <div
                                                                                            ...
                                                                                            <i
                                                                                                class="fas fa-image text-purple-600 text-xs"></i>
                                                                                        </div>
                                                                                    @endif
                                                                                </div>
                                                                                <div class="flex-1 min-w-0">
                                                                                    <p
                                                                                        class="text-xs font-medium text-purple-800 truncate">
                                                                                    ...
                                                                                    @if ($orderItemDesign->notes)
                                                                                        <p
                                                                                            ...
                                                                                            <i
                                                                                                class="fas fa-sticky-note mr-1"></i>
                                                        ...
                                                        @else
                                                            <div class="mt-2">
                                                                <span class="text-xs text-gray-500 italic">
                                                                    <i class="fas fa-palette mr-1"></i>
                                                                    {{ trans('dashboard.no_designs_attached') }}
                                                                </span>
                                                            </div>
                                                        @endif
                                                    </div>
