...
@section('pageTitle', 'Admin | Marketer Details')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">تفاصيل المسوق</h1>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-900">{{ $marketer->phone ?? 'غير محدد' }}</p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">الحالة</label>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $marketer->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div>
                            <label class="block text-sm font-medium text-gray-700">عدد الـ Leads المسندة</label>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">الـ Leads المسندة لهذا المسوق</h3>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <a href="{{ route('admin.leads.show', $lead) }}" class="text-blue-600 hover:text-blue-800">
                                    {{ $lead->company_name }}
                                </a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $lead->contact_person }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $lead->created_at->format('Y-m-d') }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
