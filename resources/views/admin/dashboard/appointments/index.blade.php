...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold" style="color: var(--brand-brown);">{{ __('admin.appointments_management') }}
                </h1>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            @if ($appointment->designer)
                                                <div class="text-sm text-gray-500">{{ $appointment->designer->email }}
                                                </div>
                                            @endif
                                        </div>
                                    </td>
                                    <td>
                                        <div>
                                            ...
                                            @if ($appointment->appointment_time)
                                                <div class="text-sm text-gray-500">{{ $appointment->appointment_time }}
                                                </div>
                                            @endif
                                        </div>
                                    </td>
