...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold" style="color: var(--brand-brown);">{{ __('admin.edit_appointment') }}</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-lg font-semibold" style="color: var(--brand-brown);">{{ __('admin.edit_appointment_details') }}</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.appointments.update', $appointment) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Appointment Date -->
                            <div>
                                <label for="appointment_date" class="form-label">{{ __('admin.appointment_date') }}</label>
                            ...
                            <!-- Appointment Time -->
                            <div>
                                <label for="appointment_time" class="form-label">{{ __('admin.appointment_time') }}</label>
        ...
        <div class="lg:col-span-1">
            <div class="card">
                <div class="card-header">
                    <h3 class="text-lg font-semibold" style="color: var(--brand-brown);">{{ __('admin.appointment_info') }}</h3>
                </div>
                <div class="card-body">
                    <div class="space-y-4">
                        <div>
                        ...
                        @if($appointment->created_at)
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $appointment->created_at->format('Y-m-d H:i') }}</p>
                                </div>
                            </div>
                        @endif
                        @if($appointment->accepted_at)
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $appointment->accepted_at->format('Y-m-d H:i') }}</p>
                                </div>
                            </div>
                        @endif
                        @if($appointment->completed_at)
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $appointment->completed_at->format('Y-m-d H:i') }}</p>
                                </div>
                            </div>
                        @endif
                        @if($appointment->cancelled_at)
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $appointment->cancelled_at->format('Y-m-d H:i') }}</p>
                                </div>
                            </div>
                        @endif
                    </div>
