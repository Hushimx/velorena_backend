        ...
        <div class="lg:col-span-1">
            @if($appointment->order)
                ...
                @if($appointment->order && $appointment->order->designs && $appointment->order->designs->count() > 0)
                    <div class="card mt-6">
                        <div class="card-header">
                            <h3 class="text-lg font-semibold" style="color: var(--brand-brown);">
                        ...
                        <div class="card-body">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                @foreach($appointment->order->designs as $design)
                                    <div class="bg-purple-50 rounded-lg p-3 border border-purple-200 hover:shadow-md transition-shadow">
                                        <!-- Design Image -->
