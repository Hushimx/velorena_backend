...
@section('pageTitle', __('admin.edit_highlight'))
@section('title', __('admin.edit_highlight'))
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold" style="color: var(--brand-brown);">{{ __('admin.edit_highlight') }}</h1>
                <p class="text-gray-600">{{ __('admin.edit_highlight_description') }}</p>
            </div>
            ...
            <form action="{{ route('admin.highlights.update', $highlight) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $highlight->name) }}"
                            ...
                            placeholder="{{ __('admin.enter_highlight_name') }}" required>
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" id="name_ar" name="name_ar"
                            value="{{ old('name_ar', $highlight->name_ar) }}"
                            ...
                            placeholder="{{ __('admin.enter_highlight_name_ar') }}" required>
                        @error('name_ar')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select id="sort_order" name="sort_order"
                            ...
                            <option value="1" {{ old('sort_order', $highlight->sort_order) == 1 ? 'selected' : '' }}>1
                                - First</option>
                            <option value="2" {{ old('sort_order', $highlight->sort_order) == 2 ? 'selected' : '' }}>2
                                - Second</option>
                            <option value="3" {{ old('sort_order', $highlight->sort_order) == 3 ? 'selected' : '' }}>3
                                - Third</option>
                            <option value="4" {{ old('sort_order', $highlight->sort_order) == 4 ? 'selected' : '' }}>4
                                - Fourth</option>
                            <option value="5" {{ old('sort_order', $highlight->sort_order) == 5 ? 'selected' : '' }}>5
                                - Fifth</option>
                        </select>
                        @error('sort_order')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3"
                            ...
                            placeholder="{{ __('admin.enter_highlight_description') }}">{{ old('description', $highlight->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description_ar" name="description_ar" rows="3"
                            ...
                            placeholder="{{ __('admin.enter_highlight_description_ar') }}">{{ old('description_ar', $highlight->description_ar) }}</textarea>
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center">
                            ...
                            <label for="is_active" class="mx-2 block text-sm text-gray-700">
                                {{ __('admin.is_active') }}
                            </label>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex justify-end gap-3">
                    ...
                    <button type="submit" class="btn btn-primary">
                        ...
                        <span>{{ __('admin.update_highlight') }}</span>
                    </button>
                </div>
            </form>
        </div>
