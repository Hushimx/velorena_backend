                        ...
                        <div class="mt-6 space-y-4">
                            <div class="space-y-2">
                                ...
                                <textarea name="content" id="content" rows="12" required
                                    ...
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 bg-white hover:bg-gray-50 focus:bg-white shadow-sm text-gray-900 content-textarea">{{ old('content', $post->content) }}</textarea>
                                @error('content')
                                    <p class="mt-2 text-sm text-red-600 flex items-center">
                                        <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                                    </p>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="content_ar" id="content_ar" rows="12" placeholder="{{ trans('posts.enter_post_content_ar') }}"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 bg-white hover:bg-gray-50 focus:bg-white shadow-sm text-gray-900 content-textarea">{{ old('content_ar', $post->content_ar) }}</textarea>
                                @error('content_ar')
                                    <p class="mt-2 text-sm text-red-600 flex items-center">
                                        <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                                    </p>
