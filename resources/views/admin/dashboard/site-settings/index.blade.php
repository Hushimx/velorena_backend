                            ...
                            <div class="px-6 py-4">
                                <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <div class="flex-1">
                                                ...
                                                <div class="mt-1 flex items-center space-x-2">
                                                    ...
                                                    <span class="text-sm text-gray-500">Sort: {{ $setting->sort_order }}</span>
                                                </div>
                                                                ...
                                                                @foreach($setting->localized_value as $key => $value)
                                                                    @if($key === 'logo' && $value)
                                                                        <div class="flex items-center space-x-2">
                                                                            ...
                                                                            <img src="{{ Storage::url($value) }}" alt="Logo" class="h-8 w-8 object-cover rounded">
                                                                        </div>
                                                                    @elseif(is_string($value))
                                                                        <div><span class="font-medium">{{ ucfirst($key) }}:</span> {{ Str::limit($value, 100) }}</div>
                                                                    @endif
                                                                @endforeach
                                                            </div>
                                                        @else
                                                            <p class="text-sm text-gray-600">{{ Str::limit($setting->localized_value, 100) }}</p>
                                                        @endif
                                                    </div>
                                                @endif
                                            </div>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.site-settings.destroy', $setting) }}" method="POST" class="inline"
        ...
        <div class="bg-white shadow sm:rounded-lg">
            ...
            <form action="{{ route('admin.site-settings.bulk-update') }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Site Name -->
                    <div>
                        <label for="settings[site_name][value]" class="block text-sm font-medium text-gray-700">Site Name</label>
                    ...
                    <!-- Site Description -->
                    <div>
                        <label for="settings[site_description][value]" class="block text-sm font-medium text-gray-700">Site Description</label>
                    ...
                    <!-- Contact Email -->
                    <div>
                        <label for="settings[contact_email][value]" class="block text-sm font-medium text-gray-700">Contact Email</label>
                    ...
                    <!-- Contact Phone -->
                    <div>
                        <label for="settings[contact_phone][value]" class="block text-sm font-medium text-gray-700">Contact Phone</label>
                    ...
                    <!-- Facebook URL -->
                    <div>
                        <label for="settings[facebook_url][value]" class="block text-sm font-medium text-gray-700">Facebook URL</label>
                    ...
                    <!-- Instagram URL -->
                    <div>
                        <label for="settings[instagram_url][value]" class="block text-sm font-medium text-gray-700">Instagram URL</label>
                    ...
                    <!-- Twitter URL -->
                    <div>
                        <label for="settings[twitter_url][value]" class="block text-sm font-medium text-gray-700">Twitter URL</label>
                    ...
                    <!-- LinkedIn URL -->
                    <div>
                        <label for="settings[linkedin_url][value]" class="block text-sm font-medium text-gray-700">LinkedIn URL</label>
