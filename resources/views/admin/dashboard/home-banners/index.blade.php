        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="mb-6 lg:mb-0">
                        <div class="flex items-center space-x-4 mb-4">
                            ...
                            <div>
                                <h1 class="text-5xl font-bold bg-gradient-to-r from-gray-900 via-indigo-800 to-purple-800 bg-clip-text text-transparent">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @forelse($banners as $banner)
                    <div class="group bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                        <!-- Banner Image -->
                        <div class="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 relative overflow-hidden">
                            ...
                            <div class="absolute top-4 right-4">
                                @if($banner->is_active)
                                    <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-green-400 to-emerald-500 text-white shadow-lg">
                                        <div class="w-2 h-2 bg-white rounded-full mr-2 animate-pulse"></div>
                                        {{ __('admin.active') }}
                                    </span>
                                @else
                                    <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-red-400 to-pink-500 text-white shadow-lg">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="inline-flex items-center justify-center w-8 h-8 bg-white/90 backdrop-blur-sm rounded-full text-xs font-bold text-gray-700 shadow-lg">
                                    {{ $banner->sort_order }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                @if($banner->description)
                                    <p class="text-sm text-gray-500 leading-relaxed">{{ Str::limit($banner->description, 120) }}</p>
                                @endif
                ...
                @empty
                    <div class="col-span-full">
                        <div class="text-center py-20">
                            ...
                            <p class="text-xl text-gray-500 mb-8 max-w-md mx-auto">{{ __('admin.create_your_first_banner') }}</p>
                            <a href="{{ route('admin.home-banners.create') }}" 
                               class="inline-flex items-center px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 font-semibold">
                                <i class="fas fa-plus mr-3 text-lg"></i>
                                <span>{{ __('admin.add_new_banner') }}</span>
