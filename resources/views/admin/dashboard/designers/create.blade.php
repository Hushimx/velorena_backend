...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold" style="color: var(--brand-brown);">{{ trans('designers.create_designer') }}</h1>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <textarea name="address" id="address" rows="3"
                            class="form-control @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                        @error('address')
                            <p style="margin-top: 0.25rem; font-size: 0.875rem; color: #ef4444;">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div style="grid-column: 1 / -1;">
                        ...
                        <textarea name="bio" id="bio" rows="4"
                            class="form-control @error('bio') border-red-500 @enderror">{{ old('bio') }}</textarea>
                        @error('bio')
                            <p style="margin-top: 0.25rem; font-size: 0.875rem; color: #ef4444;">{{ $message }}</p>
                        @enderror
                    </div>
