                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $designer->name) }}"
                                required class="form-control @error('name') border-red-500 @enderror">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $designer->email) }}"
                                required class="form-control @error('email') border-red-500 @enderror">
                            @error('email')
                                <p class="validation-message">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" id="phone"
                                value="{{ old('phone', $designer->phone) }}"
                        ...
                        <div style="grid-column: 1 / -1;">
                            ...
                            <textarea name="address" id="address" rows="3" class="form-control @error('address') border-red-500 @enderror">{{ old('address', $designer->address) }}</textarea>
                            @error('address')
                                <p class="validation-message">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div style="grid-column: 1 / -1;">
                            ...
                            <textarea name="bio" id="bio" rows="4" class="form-control @error('bio') border-red-500 @enderror">{{ old('bio', $designer->bio) }}</textarea>
                            @error('bio')
                                <p class="validation-message">{{ $message }}</p>
                            @enderror
                        </div>
