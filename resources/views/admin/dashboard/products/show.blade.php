                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div class="flex items-center space-x-3 mt-4 lg:mt-0 gap-3">
                        <a href="{{ route('admin.reviews.index', ['product_id' => $product->id]) }}"
                            class="inline-flex items-center gap-3 px-4 py-2 bg-yellow-600 border border-transparent rounded-lg font-medium text-sm text-white hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition duration-200">
                            <i class="fas fa-star"></i>
                            عرض التقييمات ({{ $product->reviews()->count() }})
                        </a>
