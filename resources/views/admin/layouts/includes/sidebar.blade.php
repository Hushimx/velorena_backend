    ...
    <nav class="mt-4 flex-1 px-2 space-y-1">
        ...
        <div class="tree-item">
            <a href="{{ route('admin.users.index') }}"
                ...
                onclick="toggleTree(event, 'users-tree')">
            ...
            <div class="tree-children" id="users-tree">
                <a href="{{ route('admin.users.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.users.index') ? 'active' : '' }}">
                    <i class="fas fa-list"></i>
                    <span>{{ __('admin.all_users') }}</span>
                </a>
                <a href="{{ route('admin.users.create') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.users.create') ? 'active' : '' }}">
        ...
        <div class="tree-item">
            <a href="{{ route('admin.orders.index') }}"
                ...
                onclick="toggleTree(event, 'orders-tree')">
            ...
            <div class="tree-children" id="orders-tree">
                <a href="{{ route('admin.orders.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.orders.index') && !request()->get('status') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.orders.index', ['status' => 'processing']) }}"
                    class="sidebar-link tree-child {{ request()->get('status') === 'processing' ? 'active' : '' }}">
                    <i class="fas fa-cog text-blue-500"></i>
                    <span>{{ __('admin.order_processing') }}</span>
                </a>
                <a href="{{ route('admin.orders.index', ['status' => 'completed']) }}"
                    class="sidebar-link tree-child {{ request()->get('status') === 'completed' ? 'active' : '' }}">
        ...
        <div class="tree-item">
            <a href="{{ route('admin.products.index') }}"
                ...
                onclick="toggleTree(event, 'products-tree')">
            ...
            <div class="tree-children" id="products-tree">
                <a href="{{ route('admin.products.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.products.index') ? 'active' : '' }}">
                    <i class="fas fa-th-large"></i>
                    <span>{{ __('admin.all_products') }}</span>
                </a>
                <a href="{{ route('admin.products.create') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.products.create') ? 'active' : '' }}">
                    <i class="fas fa-plus"></i>
                    <span>{{ __('admin.add_product') }}</span>
                </a>
                <a href="{{ route('admin.categories.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}">
                    <i class="fas fa-tags"></i>
                    <span>{{ __('admin.categories') }}</span>
                </a>
                <a href="{{ route('admin.highlights.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.highlights.*') ? 'active' : '' }}">
        ...
        <div class="tree-item">
            <a href="{{ route('admin.support-tickets.index') }}"
                ...
                onclick="toggleTree(event, 'support-tickets-tree')">
            ...
            <div class="tree-children" id="support-tickets-tree">
                <a href="{{ route('admin.support-tickets.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.support-tickets.index') ? 'active' : '' }}">
                    <i class="fas fa-list"></i>
                    <span>{{ __('admin.all_tickets') }}</span>
                </a>
                <a href="{{ route('admin.support-tickets.index', ['status' => 'open']) }}"
                    class="sidebar-link tree-child {{ request()->get('status') === 'open' ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.support-tickets.index', ['status' => 'in_progress']) }}"
                    class="sidebar-link tree-child {{ request()->get('status') === 'in_progress' ? 'active' : '' }}">
                    <i class="fas fa-cog text-blue-500"></i>
                    <span>{{ __('admin.in_progress_tickets') }}</span>
                </a>
                <a href="{{ route('admin.support-tickets.statistics') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.support-tickets.statistics') ? 'active' : '' }}">
        ...
        <!-- Availability Slots -->
        <a href="{{ route('admin.availability-slots.index') }}"
            class="sidebar-link {{ request()->routeIs('admin.availability-slots.*') ? 'active' : '' }}">
        ...
        <div class="tree-item">
            <a href="#"
                class="sidebar-link {{ request()->routeIs('admin.home-banners.*') || request()->routeIs('admin.pages.*') || request()->routeIs('admin.site-settings.*') ? 'active' : '' }}"
                onclick="toggleTree(event, 'settings-tree')">
            ...
            <div class="tree-children" id="settings-tree">
                <a href="{{ route('admin.home-banners.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.home-banners.*') ? 'active' : '' }}">
                    <i class="fas fa-images"></i>
                    <span>{{ __('admin.home_banners_management') }}</span>
                </a>
                <a href="{{ route('admin.pages.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.pages.*') ? 'active' : '' }}">
                    <i class="fas fa-file-alt"></i>
                    <span>Pages Management</span>
                </a>
                <a href="{{ route('admin.site-settings.index') }}"
                    class="sidebar-link tree-child {{ request()->routeIs('admin.site-settings.*') ? 'active' : '' }}">
