...
return [
    ...
    "add_products_to_cart" => "يرجى إضافة منتجات إلى سلة التسوق قبل حجز موعد.",
    "browse_products" => "تصفح المنتجات",
    "cart_items" => "عناصر السلة",
    "quantity" => "الكمية",
    "add_items_to_cart" => "أضف عناصر إلى السلة أولاً",
    "available_slots" => "المواعيد المتاحة",
    "select_time_slot" => "اختر الموعد المناسب لك",
    "cart_empty_message" => "سلة التسوق فارغة. يرجى إضافة منتجات إلى سلة التسوق قبل حجز موعد.",
    "select_time_first" => "اختر الوقت أولاً",
    ...
    "notes" => "ملاحظات",
    "attached_designs" => "التصاميم المرفقة",
    "no_designs_attached" => "لا توجد تصاميم مرفقة",
    "quick_add_products" => "إضافة منتجات سريعة",
    "quick_add" => "إضافة سريعة",
    "popular_services" => "الخدمات الشائعة",
    "basic_consultation" => "استشارة تصميم أساسية",
    "basic_consultation_desc" => "خدمة استشارة تصميم أساسية",
    "premium_package" => "باقة تصميم مميزة",
    "premium_package_desc" => "باقة تصميم شاملة مع ميزات مميزة",
    "custom_design" => "خدمة تصميم مخصصة",
    "custom_design_desc" => "خدمة تصميم مخصصة بالكامل",
    "revision_service" => "خدمة المراجعة",
    "revision_service_desc" => "خدمة مراجعة وتعديل التصميم",
    "full_editor" => "المحرر الكامل",
    "navigate_to_sections" => "التنقل إلى الأقسام الأخرى",
