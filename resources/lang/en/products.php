...
return [
    ...
    "slug" => "Slug",
    "enter_product_slug" => "Enter product slug (URL-friendly)",
    "slug_help" => "Leave empty to auto-generate from product name",
    "meta_title" => "Meta Title",
    "enter_meta_title" => "Enter meta title for SEO",
    "meta_title_help" => "Title for search engines (recommended: 50-60 characters)",
    "meta_description" => "Meta Description",
    "enter_meta_description" => "Enter meta description for SEO",
    "meta_description_help" => "Description for search engines (recommended: 150-160 characters)",
    "meta_keywords" => "Meta Keywords",
    "enter_meta_keywords" => "Enter keywords separated by commas",
    "meta_keywords_help" => "Keywords for search engines (separated by commas)",
    "og_title" => "Open Graph Title",
    "enter_og_title" => "Enter Open Graph title for social sharing",
    "og_title_help" => "Title for social media sharing (Facebook, Twitter, etc.)",
    "og_description" => "Open Graph Description",
    "enter_og_description" => "Enter Open Graph description for social sharing",
    "og_description_help" => "Description for social media sharing (Facebook, Twitter, etc.)",
