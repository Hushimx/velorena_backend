...
return [
    ...
    "edit_marketer_data" => "Edit marketer data: :name",
    "new_password" => "New Password",
    "new_password_placeholder" => "Leave empty if you don't want to change the password",
    "update_marketer" => "Update Marketer",
    "marketer_details" => "Marketer Details",
    "basic_information" => "Basic Information",
    "statistics" => "Statistics",
    "assigned_leads_count" => "Assigned Leads Count",
    "created_at" => "Created At",
    ...
    "add_new_lead_to_platform" => "Add new lead to the platform",
    "company_name" => "Company Name",
    "contact_person" => "Contact Person",
    "address" => "Address",
    "new" => "New",
    ...
    "medium" => "Medium",
    "high" => "High",
    "responsible_marketer" => "Responsible Marketer",
    ...
    "create_new_ticket_description" => "Create a new support ticket for a customer",
    "create_ticket_details" => "Create Ticket Details",
    "create_ticket" => "Create Ticket",
    "select_customer" => "Select Customer",
    "help_information" => "Help Information",
    "ticket_creation_help" => "Ticket Creation Help",
    "ticket_creation_help_description" => "Fill in all required fields to create a new support ticket. The ticket will be automatically assigned a unique ticket number.",
    "priority_guidelines" => "Priority Guidelines",
    "category_guidelines" => "Category Guidelines",
    "urgent_description" => "Critical issues affecting system functionality",
    "high_description" => "Important issues that need prompt attention",
    "medium_description" => "Standard issues that can be addressed during business hours",
    "low_description" => "Minor issues or general inquiries",
    "technical_description" => "Technical problems, bugs, or system issues",
    "billing_description" => "Payment, invoice, or billing related issues",
    "general_description" => "General questions or non-specific issues",
    "feature_request_description" => "Requests for new features or improvements",
    "bug_report_description" => "Reports of software bugs or errors",
    ...
    'edit_highlight_description' => 'Update the highlight information below',
    ...
    'create_new_appointment' => 'Create a new appointment for a user',
    ...
    'appointment_notes_placeholder' => 'Enter any additional notes for this appointment...',
    'order_notes' => 'Order Notes',
    'order_notes_placeholder' => 'Enter any notes related to the order...',
    'appointment_created_success' => 'Appointment created successfully',
    'user' => 'User',
    'designer' => 'Designer',
    'order' => 'Order',
    'create_appointment_details' => 'Create Appointment Details',
    'new_appointment_info' => 'New Appointment Information',
    ...
    'required_fields_description' => 'User, date, time, and duration are required',
    'optional_fields' => 'Optional Fields',
    'optional_fields_description' => 'Designer and order can be selected later',
    'appointment_timing' => 'Appointment Timing',
    'appointment_timing_description' => 'Date must be at least tomorrow',
    ...
    // Lead Edit Page
    'edit_lead' => 'Edit Lead',
    'edit_lead_data' => 'Edit lead data: :name',
